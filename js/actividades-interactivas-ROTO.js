...
console.log('🚀 Iniciando carga del sistema de actividades interactivas...');
...
console.log('✅ ActividadState inicializado:', ActividadState);
...
console.log('✅ MeditacionState inicializado');
    ...
    actividad1: {
        ...
        fases: [
            ...
            },
            {
                ...
                titulo: '🔍 Laboratorio de Manchas Mágicas',
                tipo: 'interactivo',
                contenido: {
                    narrativa: "En este laboratorio secreto, puedes crear manchas mágicas y observarlas desde diferentes ángulos...",
                    herramientas: ['generador-manchas', 'rotador-vista', 'lupa-detalle'],
                    preguntasGuia: [
            ...
            },
            {
                ...
                titulo: '✏️ Atelier del Personaje',
                tipo: 'creativo',
                contenido: {
                    narrativa: "Ha llegado el momento de dar vida a tu personaje. Usa tus herramientas mágicas para completar su historia visual...",
                    herramientas: ['pincel-magico', 'paleta-emociones', 'transformador-lineas'],
                    misionEspecial: "Transforma tu mancha favorita en un personaje único agregando detalles, expresiones y vida"
                }
            },
            {
                id: 'movimiento-corporal',
                titulo: '💃 Danza de la Mancha Viviente',
                tipo: 'corporal',
                contenido: {
                    narrativa: "Tu personaje quiere moverse... ¡y tú eres su guía! Vamos a explorar el movimiento para ver nuevas posibilidades...",
                    ejercicios: [
                        "Imita los movimientos de tu personaje",
                        "Gira tu cuerpo y observa cómo cambia la perspectiva",
                        "Dibuja en el aire los gestos de tu personaje"
                    ]
                }
            },
            {
...
console.log('✅ ACTIVIDADES_CONFIG cargado:', Object.keys(ACTIVIDADES_CONFIG));
console.log('✅ Total de actividades:', Object.keys(ACTIVIDADES_CONFIG).length);
                        ...
                        <div class="space-y-6">
                            ...
                            <div class="seccion-herramientas">
                                ...
                                <div class="grid grid-cols-2 gap-2">
                                    <button onclick="seleccionarHerramientaAvanzada('pincel-solido')" class="herramienta-btn bg-gradient-to-br from-blue-100 to-blue-200 hover:from-blue-200 hover:to-blue-300 p-3 rounded-lg border-2 border-blue-300 transition-all text-center">
                                        <div class="text-2xl mb-1">🖌️</div>
                                        <div class="text-xs font-medium">Sólido</div>
                                    </button>
                                    
                                    <button onclick="seleccionarHerramientaAvanzada('aerografo')" class="herramienta-btn bg-gradient-to-br from-cyan-100 to-cyan-200 hover:from-cyan-200 hover:to-cyan-300 p-3 rounded-lg border-2 border-cyan-300 transition-all text-center">
                                        <div class="text-2xl mb-1">💨</div>
                                        <div class="text-xs font-medium">Aerógrafo</div>
                                    </button>
                                    
                                    <button onclick="seleccionarHerramientaAvanzada('textura')" class="herramienta-btn bg-gradient-to-br from-green-100 to-green-200 hover:from-green-200 hover:to-green-300 p-3 rounded-lg border-2 border-green-300 transition-all text-center">
                                        <div class="text-2xl mb-1">🎨</div>
                                        <div class="text-xs font-medium">Textura</div>
                                    </button>
                                    
                                    <button onclick="seleccionarHerramientaAvanzada('caligrafia')" class="herramienta-btn bg-gradient-to-br from-purple-100 to-purple-200 hover:from-purple-200 hover:to-purple-300 p-3 rounded-lg border-2 border-purple-300 transition-all text-center">
                                        <div class="text-2xl mb-1">✒️</div>
                                        <div class="text-xs font-medium">Caligrafía</div>
                                    </button>
                                    
                                    <button onclick="seleccionarHerramientaAvanzada('difumino')" class="herramienta-btn bg-gradient-to-br from-pink-100 to-pink-200 hover:from-pink-200 hover:to-pink-300 p-3 rounded-lg border-2 border-pink-300 transition-all text-center">
                                        <div class="text-2xl mb-1">🌫️</div>
                                        <div class="text-xs font-medium">Difumino</div>
                                    </button>
                                    
                                    <button onclick="seleccionarHerramientaAvanzada('acuarela')" class="herramienta-btn bg-gradient-to-br from-indigo-100 to-indigo-200 hover:from-indigo-200 hover:to-indigo-300 p-3 rounded-lg border-2 border-indigo-300 transition-all text-center">
                                        <div class="text-2xl mb-1">🌊</div>
                            ...
                            <div class="seccion-herramientas">
                                ...
                                <div class="grid grid-cols-2 gap-2">
                                    <button onclick="seleccionarHerramientaAvanzada('relleno')" class="herramienta-btn bg-gradient-to-br from-yellow-100 to-orange-200 hover:from-yellow-200 hover:to-orange-300 p-3 rounded-lg border-2 border-orange-300 transition-all text-center">
                                        <div class="text-2xl mb-1">🪣</div>
                                        <div class="text-xs font-medium">Bote</div>
                                    </button>
                                    
                                    <button onclick="seleccionarHerramientaAvanzada('gradiente-lineal')" class="herramienta-btn bg-gradient-to-br from-violet-100 to-purple-200 hover:from-violet-200 hover:to-purple-300 p-3 rounded-lg border-2 border-purple-300 transition-all text-center">
                                        <div class="text-2xl mb-1">📐</div>
                                        <div class="text-xs font-medium">Gradiente</div>
                                    </button>
                                    
                                    <button onclick="seleccionarHerramientaAvanzada('gradiente-radial')" class="herramienta-btn bg-gradient-to-br from-rose-100 to-pink-200 hover:from-rose-200 hover:to-pink-300 p-3 rounded-lg border-2 border-pink-300 transition-all text-center">
                                        <div class="text-2xl mb-1">🌟</div>
                                        <div class="text-xs font-medium">Radial</div>
                                    </button>
                                    
                                    <button onclick="seleccionarHerramientaAvanzada('borrador')" class="herramienta-btn bg-gradient-to-br from-gray-100 to-gray-200 hover:from-gray-200 hover:to-gray-300 p-3 rounded-lg border-2 border-gray-300 transition-all text-center">
                                        <div class="text-2xl mb-1">🧽</div>
...
function generarSimuladorManchaAvanzado(fase, actividadId) {
    return `
        <div class="fase-creativa-avanzada max-w-7xl mx-auto">
            ...
            <!-- Container para el simulador avanzado -->
            <div id="herramientas-mancha-container">
                <!-- El simulador se cargará aquí -->
            </div>
            ...
            <div class="espacio-meditacion bg-gradient-to-br from-indigo-100 to-purple-100 p-8 rounded-3xl border-2 border-indigo-300 mb-8">
                ...
                <div class="controles-meditacion space-y-4">
                    <div class="flex gap-4 justify-center">
                        <button class="btn-meditacion bg-gradient-to-r from-green-500 to-blue-500 hover:from-green-600 hover:to-blue-600 text-white font-bold py-3 px-6 rounded-full shadow-lg transition-all" onclick="iniciarMeditacion()">
                            🌟 Comenzar Meditación Guiada
                        </button>
                        <button class="btn-meditacion bg-gradient-to-r from-gray-500 to-gray-600 hover:from-gray-600 hover:to-gray-700 text-white font-bold py-3 px-6 rounded-full shadow-lg transition-all" onclick="saltarMeditacion()">
                            ⏭️ Saltar Meditación
                        </button>
                    </div>
        ...
        <div class="fase-reflexion max-w-4xl mx-auto text-center">
            ...
            <div class="celebracion-interactiva bg-gradient-to-r from-pink-100 to-purple-100 p-8 rounded-2xl border-2 border-pink-300">
                ...
                <div class="espacio-celebracion mb-6">
                    <button class="btn-celebracion bg-gradient-to-r from-yellow-400 to-orange-500 hover:from-yellow-500 hover:to-orange-600 text-white text-xl font-bold py-4 px-8 rounded-full shadow-lg transform transition-all hover:scale-105" onclick="celebrarLogro()">
                ...
                ${esUltimaActividad ? `
                    <div class="opciones-finales flex flex-wrap gap-4 justify-center">
                        <button class="btn-opcion bg-gradient-to-r from-blue-500 to-indigo-600 hover:from-blue-600 hover:to-indigo-700 text-white font-bold py-3 px-6 rounded-full transition-all" onclick="revisarViaje()">
                            📚 Revisar Todo mi Viaje
                        </button>
                        <button class="btn-opcion bg-gradient-to-r from-green-500 to-teal-600 hover:from-green-600 hover:to-teal-700 text-white font-bold py-3 px-6 rounded-full transition-all" onclick="nuevaAventura()">
                            🔄 Nueva Aventura
                        </button>
                        <button class="btn-opcion bg-gradient-to-r from-purple-500 to-pink-600 hover:from-purple-600 hover:to-pink-700 text-white font-bold py-3 px-6 rounded-full transition-all" onclick="compartirExperiencia()">
...
function configurarFaseCreativa(actividadId) {
    ...
    if (canvasProfesional && document.querySelector('.estudio-arte-pro')) {
        ...
        inicializarEstudioArteProfesional();
        return;
    }
...
function cargarSimuladorManchaAvanzado() {
    ...
    if (!container) {
        console.warn('Container del simulador no encontrado');
        return;
    }

    // Verificar si el simulador ya existe
    if (window.SimuladorManchaAvanzado) {
        console.log('✨ Inicializando simulador avanzado de manchas...');
        try {
            window.SimuladorManchaAvanzado.inicializar(container);
        } catch (error) {
            console.error('Error al inicializar simulador:', error);
            mostrarFallbackCanvas(container);
        }
    } else {
        // Cargar el script del simulador
        console.log('🔄 Cargando simulador avanzado...');
        const script = document.createElement('script');
        script.src = 'js/simulador-mancha-avanzado.js';
        script.onload = function() {
            console.log('✅ Simulador cargado exitosamente');
            if (window.SimuladorManchaAvanzado) {
                try {
                    window.SimuladorManchaAvanzado.inicializar(container);
                } catch (error) {
                    console.error('Error al inicializar simulador después de carga:', error);
                    mostrarFallbackCanvas(container);
                }
            } else {
                console.error('SimuladorManchaAvanzado no está disponible después de la carga');
                mostrarFallbackCanvas(container);
            }
        };
        script.onerror = function() {
            console.error('❌ Error cargando el simulador avanzado');
            mostrarFallbackCanvas(container);
        };
        ...
        <div class="simulador-fallback bg-gradient-to-br from-yellow-50 to-orange-50 p-8 rounded-2xl border-2 border-yellow-300">
            ...
            <div class="grid lg:grid-cols-4 gap-6">
                ...
                <div class="lg:col-span-3">
                    ...
                    <div class="mt-4 bg-gradient-to-r from-green-100 to-teal-100 p-4 rounded-lg border-2 border-green-300">
                        <h4 class="font-bold text-green-700 mb-3">🎭 Creador de Personajes</h4>
                        <div class="grid md:grid-cols-2 gap-4">
                            <div>
                                <label class="block font-medium text-green-600 mb-2">Nombre del personaje:</label>
                                <input type="text" id="nombre-personaje" placeholder="Ej: Manchita, Colorín, Gotín..." class="w-full p-2 border-2 border-green-300 rounded-lg">
                            </div>
                            <div>
                                <label class="block font-medium text-green-600 mb-2">Personalidad:</label>
                                <select id="personalidad-personaje" class="w-full p-2 border-2 border-green-300 rounded-lg">
                                    <option value="">Selecciona...</option>
                                    <option value="aventurero">🗺️ Aventurero</option>
                                    <option value="timido">😊 Tímido</option>
                                    <option value="alegre">😄 Alegre</option>
                                    <option value="misterioso">🕵️ Misterioso</option>
                                    <option value="creativo">🎨 Creativo</option>
                                    <option value="sabio">🧙‍♂️ Sabio</option>
                                </select>
                            </div>
                        </div>
                        <div class="mt-3">
                            <button onclick="guardarPersonaje()" class="bg-gradient-to-r from-green-500 to-teal-500 hover:from-green-600 hover:to-teal-600 text-white px-4 py-2 rounded-lg font-bold transition-all transform hover:scale-105 shadow-md">
                                💾 Guardar Personaje
                            </button>
                        </div>
                    </div>
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <select id="tipo-pincel" class="w-full p-2 border-2 border-gray-300 rounded-lg">
                                <option value="normal">✏️ Pincel Normal</option>
                                <option value="grueso">🖌️ Pincel Grueso</option>
                                <option value="spray">💨 Spray</option>
                                <option value="dedo">👆 Dedo Virtual</option>
                            </select>
                        </div>
...
/**
 * Configurar canvas básico de fallback
 */
function configurarCanvasBasico() {
    ...
    console.log('🎨 Canvas básico configurado exitosamente');
}
...
function guardarPersonaje() {
    ...
    if (!nombre) {
        mostrarNotificacion('🎭 Por favor, escribe un nombre para tu personaje', 'warning');
        return;
    }
    
    if (!personalidad) {
        mostrarNotificacion('🎭 Por favor, selecciona una personalidad para tu personaje', 'warning');
        return;
    }
    ...
    const canvas = document.getElementById('canvas-principal');
    if (!canvas) {
        mostrarNotificacion('🎨 Primero crea una mancha para tu personaje', 'warning');
        return;
    }
    ...
    mostrarNotificacion(`🎭 ¡${nombre} ha sido creado! Es un personaje ${personalidadTexto.toLowerCase()} que vivirá para siempre en tu galería`, 'success');
...
function generarManchaAleatoria() {
    ...
    mostrarNotificacion('🎨 ¡Mancha de acuarela generada! Observa qué formas puedes encontrar', 'success');
}
...
function iniciarMeditacion() {
    document.getElementById('meditation-btn')?.style.setProperty('display', 'none');
    document.getElementById('skip-btn')?.style.setProperty('display', 'none');
    
    mostrarMeditacionGuiada();
}
...
function saltarMeditacion() {
    document.getElementById('meditation-btn')?.style.setProperty('display', 'none');
    document.getElementById('skip-btn')?.style.setProperty('display', 'none');
    document.getElementById('meditacion-completada')?.classList.remove('hidden');
    
    const textoMeditacion = document.getElementById('texto-meditacion');
    if (textoMeditacion) {
        textoMeditacion.innerHTML = '<strong>✨ ¡Perfecto! Ahora vamos a crear arte con tu lugar especial en mente.</strong>';
    }
}

/**
 * Mostrar meditación guiada
 */
function mostrarMeditacionGuiada() {
    const textos = ActividadState.textosMeditacion || [
        "Cierra los ojos suavemente... respira profundo...",
        "Imagina una puerta dorada en tu mente...",
        "Esa puerta se abre hacia tu lugar especial...",
        "Observa los colores... ¿son cálidos o frescos?",
        "Escucha los sonidos de tu lugar...",
        "Siente las texturas, los aromas...",
        "Graba cada detalle en tu memoria..."
    ];
        ...
        if (indice < textos.length) {
            ...
            if (textoElemento) {
                ...
                setTimeout(() => {
                    ...
                    // Hablar el texto si está disponible
                    hablarTexto(textos[indice]);
                }, 300);
            }
            
            // Actualizar círculo de respiración con mensajes más naturales
            if (circulo) {
            ...
            // Tiempos variables para hacer la experiencia más natural
            const tiempos = [
                6000,  // Presentación de Luna (6 segundos)
                8000,  // Respiración guiada (8 segundos)
                7000,  // Puerta dorada (7 segundos)
                10000, // Llegada al lugar (10 segundos)
                12000, // Observar colores (12 segundos)
                12000, // Escuchar sonidos (12 segundos)
                15000, // Sentir texturas y aromas (15 segundos)
                10000  // Mensaje final (10 segundos)
            ];
            
            const tiempoEspera = tiempos[indice - 1] || 8000;
            setTimeout(mostrarSiguienteTexto, tiempoEspera);
        } else {
...
function completarMeditacion() {
    ...
    if (textoElemento) {
        ...
        hablarTexto('¡Qué hermoso viaje hicimos juntos! Tu lugar especial ahora vive en tu corazón para siempre. Cuando quieras, puedes cerrar los ojos y regresar ahí. Ahora vamos a crear arte con todo ese amor que sientes por tu lugar mágico. ¡Será increíble!');
    }
    
    if (completadaDiv) {
        setTimeout(() => {
            completadaDiv.classList.remove('hidden');
        }, 3000); // Un poco más de tiempo para el mensaje final
    }
}

/**
 * Hablar texto (síntesis de voz)
 */
function hablarTexto(texto) {
    if ('speechSynthesis' in window) {
        ...
        // Configuración para voz más natural y cálida de niña
        utterance.rate = 0.6;        // Más lenta para ser más tranquila
        utterance.pitch = 1.2;       // Tono más alto, como voz de niña
        utterance.volume = 0.9;      // Volumen claro pero suave
        ...
        const vozPreferida = voces.find(voz => 
            ...
            (voz.name.toLowerCase().includes('female') || 
             ...
             voz.name.toLowerCase().includes('maría') ||
        ...
        // Agregar pausas naturales antes de hablar
        utterance.onstart = () => {
            console.log('🌙 Luna está hablando...');
        };
...
// Funciones del Estudio Profesional
window.seleccionarHerramientaAvanzada = seleccionarHerramientaAvanzada;
    ...
    Object.entries(coloresEmociones).forEach(([emocion, color]) => {
        html += `
            <button class="color-emocion p-3 rounded-lg text-center transition-all hover:scale-105" 
                    ...
                    onclick="seleccionarColorEmocion('${color}', '${emocion}')">
                ${emocion}
            </button>
        `;
    });
...
function limpiarCanvas() {
    if (ActividadState.actividadActual === 'actividad2') {
        mostrarNotificacionActividad('🚫 No puedes limpiar en esta actividad - ¡Es parte del proceso!', 'warning');
        return;
    }
    
    if (ActividadState.canvas && ActividadState.ctx) {
        ActividadState.ctx.clearRect(0, 0, ActividadState.canvas.width, ActividadState.canvas.height);
        mostrarNotificacionActividad('🗑️ Canvas limpiado', 'info');
    }
}
 ...
 */
function guardarCreacion() {
    if (!ActividadState.canvas) return;
    
    const link = document.createElement('a');
    link.download = `error-creativo-${ActividadState.actividadActual}-${Date.now()}.png`;
    link.href = ActividadState.canvas.toDataURL();
    link.click();
    
    mostrarNotificacionActividad('💾 ¡Creación guardada exitosamente!', 'success');
}
...
/**
 * Función para mostrar actividad desde la página principal
 */
function mostrarActividad(numeroActividad) {
    // Mapear número de actividad a ID
    ...
    const vistaLaboratorio = document.getElementById('vista-laboratorio');
    if (vistaLaboratorio) {
        ...
        // Mostrar laboratorio
        vistaLaboratorio.style.display = 'block';
        ...
        const labBtn = document.querySelector('[data-target="vista-laboratorio"]');
        if (labBtn) {
    ...
    const activitySelection = document.getElementById('activity-selection-container');
    if (activitySelection) {
        activitySelection.style.display = 'none';
    }
    
    // Iniciar la actividad específica
    setTimeout(() => {
...
// ===============================================
// EXPORTACIONES GLOBALES - FUNCIONES PRINCIPALES
// ===============================================
...
// Exportar funciones principales de actividades
window.iniciarActividadInteractiva = iniciarActividadInteractiva;
window.mostrarActividad = mostrarActividad;
window.siguienteFaseActividad = siguienteFaseActividad;
window.mostrarFaseActividad = mostrarFaseActividad;

// Exportar funciones del laboratorio
window.activarHerramientaMancha = activarHerramientaMancha;
window.limpiarManchaPersonal = limpiarManchaPersonal;
window.guardarManchaPersonal = guardarManchaPersonal;
window.inicializarMiniSimulador = inicializarMiniSimulador;
...
console.log('📊 Estado ActividadState:', ActividadState);
console.log('📊 Configuración cargada:', Object.keys(ACTIVIDADES_CONFIG));
