...
window.inicializarCanvasSimple = function() {
    ...
    function iniciarDibujo(e) {
        ...
        estado.lastX = pos.x;
        estado.lastY = pos.y;
        console.log('🖱️ Inicio dibujo en:', pos);
    }
    ...
    function dibujar(e) {
        ...
        // IMPORTANTE: Resetear el contexto antes de cada trazo
        ctx.save();
        
        // Aplicar el color SIEMPRE antes de dibujar
        ...
        console.log('🎨 Dibujando con color:', estado.color); // Debug
        ...
        switch(herramienta) {
            ...
            case 'gradiente-lineal':
                ...
                gradient.addColorStop(0, estado.color);
                ...
                ctx.lineTo(pos.x, pos.y);
                ctx.stroke();
                // No necesitamos resetear strokeStyle porque restore() lo hará
                break;
            ...
            case 'gradiente-radial':
                ...
                radialGradient.addColorStop(0, estado.color);
                radialGradient.addColorStop(1, 'transparent');
                ctx.fillStyle = radialGradient;
                ctx.beginPath();
                ctx.arc(pos.x, pos.y, estado.tamano * 2, 0, Math.PI * 2);
                ctx.fill();
                // No necesitamos resetear fillStyle porque restore() lo hará
                break;
            ...
            case 'borrador':
                ...
                ctx.fill();
                // No necesitamos resetear porque restore() lo hará
                break;
...
function configurarFaseCreativa(actividadId) {
    ...
    if (canvasProfesional && document.querySelector('.estudio-arte-pro')) {
        ...
        setTimeout(() => {
            // Inicializar sistema simple primero
            if (window.inicializarCanvasSimple) {
                console.log('🚀 Inicializando sistema simple de herramientas...');
                window.inicializarCanvasSimple();
            }
            // Luego intentar el avanzado si existe
