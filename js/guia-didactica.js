        ...
        anexos: [
            {
                ...
                archivo: "Material de apoyo/¡Crea Tu Personaje de Mancha!.pdf",
                icono: "description"
            },
            {
                nombre: "Tarjetas de Inspiración",
                descripcion: "Para desbloquear estudiantes que se atasquen",
                archivo: "Material de apoyo/Tarjetas desbloquear.pdf",
                icono: "style"
            }
        ]
    },
        ...
        anexos: [
            {
                ...
                archivo: "guia-didactica-lateralidades.pdf.pdf",
                icono: "self_improvement",
                seccion: "Anexo A - Actividad 2"
            },
            {
                nombre: "Ficha 'El Río de Palabras'",
                descripcion: "Guía para la escritura automática",
                archivo: "Material de apoyo/Mi Río de Palabras.pdf",
                icono: "description"
            }
        ]
    },
        ...
        anexos: [
            {
                ...
                archivo: "Material de apoyo/Reflexión, mi Viaje con el Error.pdf",
                icono: "psychology"
            }
        ]
    }
                        ...
                        <div class="bg-white rounded-lg p-4 shadow hover:shadow-lg transition-shadow">
                            <div class="flex flex-col gap-3">
                                <div class="flex items-start gap-3">
                                    <span class="material-symbols-outlined text-${actividad.color}-600 text-2xl">${anexo.icono || 'description'}</span>
                                    <div class="flex-1">
                                        <h4 class="font-bold text-gray-800 mb-1">${anexo.nombre}</h4>
                                        <p class="text-xs text-gray-600 mb-2">${anexo.descripcion}</p>
                                        ${anexo.seccion ? `<p class="text-xs text-${actividad.color}-600 font-semibold">📍 ${anexo.seccion}</p>` : ''}
                                    </div>
                                </div>
                                ${anexo.archivo ? `
                                    <a href="${anexo.archivo}" download class="flex items-center justify-center gap-2 bg-${actividad.color}-600 hover:bg-${actividad.color}-700 text-white px-4 py-2 rounded-lg text-sm font-semibold transition-colors">
                                        <span class="material-symbols-outlined text-sm">download</span>
                                        ${anexo.seccion ? 'Descargar Guía Completa' : 'Descargar PDF'}
                                    </a>
                                ` : `
                                    <div class="text-xs text-gray-500 italic text-center py-2 bg-gray-50 rounded">
                                        Ver en Guía Completa (PDF)
                                    </div>
                                `}
                            </div>
                        </div>
